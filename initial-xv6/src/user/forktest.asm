...
forktest(void)
{
  ...
  3e:	43650513          	addi	a0,a0,1078 # 470 <setpriority+0xc>
  ...
  68:	41c50513          	addi	a0,a0,1052 # 480 <setpriority+0x1c>
  ...
  b8:	41c50513          	addi	a0,a0,1052 # 4d0 <setpriority+0x6c>
  ...
  d4:	3d050513          	addi	a0,a0,976 # 4a0 <setpriority+0x3c>
  ...
  ee:	3ce50513          	addi	a0,a0,974 # 4b8 <setpriority+0x54>
